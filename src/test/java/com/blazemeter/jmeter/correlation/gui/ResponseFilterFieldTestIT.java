...
public class ResponseFilterFieldTestIT {
  ...
  public void setUp() {
    ...
    String responseFilterFieldName = "responseFilterField";
    container.add(new ResponseFilterField(responseFilterFieldName, new Dimension(200, 50),
        notificationText -> {
        }));
    container.add(SwingUtils.createComponent(TEST_BUTTON, new JButton("Click me!")));
    frame = showInFrame(container);
    responseFilterField = frame.textBox(responseFilterFieldName);
  }
