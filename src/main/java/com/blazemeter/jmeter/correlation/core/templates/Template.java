...
public class Template {
  ...
  private String type = "correlation";
  private String id;
  ...
  public void setGroups(List<RulesGroup> groups) {
    this.groups = groups;
  }
  ...
  public TemplateVersion toTemplateVersion() {
    return new TemplateVersion(getId(), getVersion());
  }
}
