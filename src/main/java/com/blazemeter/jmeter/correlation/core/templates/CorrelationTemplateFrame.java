...
public class CorrelationTemplateFrame extends JFrame implements ActionListener {
  ...
  private void buildMainPanel() {
    ...
    CollapsiblePanel dependenciesCollapsiblePanel = buildDependenciesPanel();
    ...
    layout.setHorizontalGroup(layout.createParallelGroup()
        ...
        .addGroup(layout.createSequentialGroup()
            .addComponent(dependenciesCollapsiblePanel, GroupLayout.PREFERRED_SIZE, 300,
                GroupLayout.PREFERRED_SIZE)
        )
  ...
  private CollapsiblePanel buildDependenciesPanel() {
    CollapsiblePanel collapsiblePane = SwingUtils
        .createComponent("collapsiblePane", new CollapsiblePanel("Dependencies", this::resizeFrame));
    collapsiblePane.setMinimumSize(new Dimension(300, 0));
    collapsiblePane.add(prepareDependenciesPanel());
