package com.blazemeter.jmeter.correlation.core.templates.gui;
...
import com.blazemeter.jmeter.correlation.core.templates.Validation;
import com.blazemeter.jmeter.correlation.gui.CollapsiblePanel;
import com.blazemeter.jmeter.correlation.gui.CollapsiblePanelsList;
import com.blazemeter.jmeter.correlation.gui.HeaderPanel;
...
public class CorrelationTemplateFrame extends JDialog implements ActionListener {
  ...
  private void buildMainPanel(CorrelationTemplatesRegistryHandler templatesRegistry) {
    ...
    CollapsiblePanelsList dependenciesCollapsiblePanel = buildDependenciesPanel();
  ...
  private CollapsiblePanelsList buildDependenciesPanel() {
    HeaderPanel dependencyHeader = new HeaderPanel("Dependencies");
    dependencyHeader.setPreferredSize(new Dimension(300, 30));
    ...
    CollapsiblePanel collapsiblePanel = new CollapsiblePanel(dependenciesBody, dependencyHeader,
        true);

    CollapsiblePanelsList manager = new CollapsiblePanelsList();
    manager.addComponent(collapsiblePanel);
  ...
  private ActionListener createSaveTemplateActionListener(
      CorrelationTemplatesRegistryHandler templatesRegistry,
      Consumer<CorrelationTemplate> updateLastTemplateConsumer) {
    return e -> {
