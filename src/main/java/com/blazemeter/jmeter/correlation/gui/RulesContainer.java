...
public class RulesContainer extends JPanel implements ActionListener {
  ...
  private void makeContainer() {
    ...
    JXTaskPane componentPanel = makeAdvancedComponentPanel();
  ...
  private JXTaskPane makeAdvancedComponentPanel() {
    componentContainer =
        new ComponentContainer(this::validateRulesConsistency);
    JXTaskPane collapsiblePane = SwingUtils.buildCollapsiblePane("CollapsiblePane");
    collapsiblePane.add(componentContainer);
    collapsiblePane.setTitle("Custom Extensions");
