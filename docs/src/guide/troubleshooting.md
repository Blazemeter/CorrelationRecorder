...
2. Click in the "bzm - Auto Correlation Recorder" element
...
1. Go to the Request filtering tab (Test Plan > bzm - Auto Correlation Recorder > Requests Filtering
   tab).
...
4. Clear the Recording JTL (Test Plan > bzm - Auto Correlation Recorder > View Results Tree >
   Right Click > Clear).
5. Record again.
